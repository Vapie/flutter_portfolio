     ...
     return Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          SizedBox(height: 30,),
          Text("FULL STACK DEV ( SOON 🤞 ) WHO WANTS TO TRY AND LEARN AS MUCH AS POSSIBLE ",
         ...
         Row(
           ...
           children: [
             ...
             SizedBox(width: 5,),
             Container( width: 80, height: 80,
               child: Icon(FontAwesomeIcons.fileAudio, size: 60,color: Colors.grey,)),
           ],
         ),
         Row(
           mainAxisAlignment: MainAxisAlignment.center,
           children: [
               Container( width: 80, height: 80,
                 child: Icon(FontAwesomeIcons.wordpress, size: 60,color: Colors.grey,)),
             SizedBox(width: 5,),
             Container( width: 80, height: 80,
               child: Icon(FontAwesomeIcons.atom, size: 60,color: Colors.grey,)),
             SizedBox(width: 5,),
             Container( width: 80, height: 80,
               child: Icon(FontAwesomeIcons.appStoreIos, size: 60,color: Colors.grey,)),
             SizedBox(width: 5,),
             Container( width: 80, height: 80,
               child: Icon(FontAwesomeIcons.database, size: 60,color: Colors.grey,)),
               SizedBox(width: 5,),
             Container( width: 80, height: 80,
             child: Icon(FontAwesomeIcons.appStore, size: 60,color: Colors.grey,)),
           ],
         ),
         SizedBox(height: 20,),
         ...
         Text("> Industrial IT, Innovative concepts and project management", style: TextStyle(fontSize: 18),),
        ],
      ),
    );
  }
